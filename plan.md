...
| PR-9 | `feat/admin-ui` | `worker/src/admin*`、`frontend/src/features/admin`、docs | **网页管理台**(/admin):独立管理密码(ADMIN_PASSWORD,默认关闭)、个人版设备码可视化授权、企业版表单即验即存、改名/删除;契约 docs/api.md §8 | 全部 | 本 PR |
